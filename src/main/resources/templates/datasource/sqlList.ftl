...
<div class="weadmin-nav">
    <span class="layui-breadcrumb">
        <#--<a href="/data/source/doLogin">返回列表</a>-->
        <#--<a href="">数据源管理</a>-->
        <a>
          <cite>查询列表</cite></a>
    </span>
...
<div class="weadmin-body">
    ...
    <div class="layui-btn-group toolBtn">
        ...
        <#--<button class="layui-btn" onclick="WeAdminShow('添加查询','/data/source/goAdd',600,400)"><i class="layui-icon"></i>添加</button>-->
    ...
    <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="query">执行查询</a>
        <#--<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>-->
    </script>
    <table class="layui-table" id="sqlList" lay-filter="sqlFilter"></table>
</div>
...
<script>
    layui.use(['table','laytpl'], function(){
        ...
        var $ = layui.$,active = {
            ...
            ,goAdd: function(){//新增查询
                document.location = "/data/source/goAdd";
            }
            ,del: function(){//批量删除
                var checkStatus = table.checkStatus('sqlList'),data = checkStatus.data;
